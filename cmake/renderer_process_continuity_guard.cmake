...
if(NOT safe_stdout MATCHES "timing_clock=steady")
  message(FATAL_ERROR "safe external dispatch did not identify the timing clock")
endif()
if(NOT safe_stdout MATCHES "capability_process_elapsed_us=[0-9]+")
  message(FATAL_ERROR "safe external dispatch did not report capability process timing")
endif()
if(NOT safe_stdout MATCHES "render_process_elapsed_us=[0-9]+")
  message(FATAL_ERROR "safe external dispatch did not report render process timing")
endif()
if(NOT safe_stdout MATCHES "receipt_verification_elapsed_us=[0-9]+")
  message(FATAL_ERROR "safe external dispatch did not report receipt verification timing")
endif()
if(NOT safe_stdout MATCHES "external_dispatch_elapsed_us=[0-9]+")
  message(FATAL_ERROR "safe external dispatch did not report total dispatch timing")
endif()
...
message(STATUS "external_dispatch_timing_evidence=PASS")
